...
{   
    l->sizes = (int*)malloc(n_particles*sizeof(int));   
    l->pool = (void*)malloc(250*n_particles*sizeof(sph_neighbour));   
    l->p = (sph_neighbour**)malloc(n_particles*sizeof(sph_neighbour*));   
}   
...
{   
    ...
    fmin_x = fmin_y = fmin_z = 99999999;//1000;    
    fmax_x = fmax_y = fmax_z = -99999999;//-1000;    
    for (i = start; i <= end; i++)   
    {   
...
{   
    ...
    {   
        ...
        if (g->sizes[gindex] == g->caps[gindex])   
        {   
            g->particles[gindex] = (particle_index*)sph_mem_pool_alloc(&g->mempool, 300*sizeof(particle_index));   
            g->caps[gindex] = 300;   
        }   
